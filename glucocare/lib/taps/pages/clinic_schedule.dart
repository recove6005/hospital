...
class ClinicSchedulePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const ClinicScheduleForm(),
    );
  }
}

class ClinicScheduleForm extends StatefulWidget {
  const ClinicScheduleForm({super.key});

  @override
  State<ClinicScheduleForm> createState() => _ClinicScheduleFormState();
}

class _ClinicScheduleFormState extends State<ClinicScheduleForm> {
  ...
  Future<void> _getCurReservations() async {
    List<ReservationModel> templist = await ReservationRepository.selectAllReservationsByCurUid();
