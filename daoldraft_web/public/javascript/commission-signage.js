...
function getPrice(membersheType) {
    ...
    if(membersheType === '1') {
        ...
        discountPriceElement.textContent = '47,500 원';
        priceElement.style.textDecoration = 'line-through';
        allprice.value = '47500';
    }
    else if(membersheType === '2') {
        discountPriceElement.style.display = 'block';
        discountPriceElement.textContent = '45,000 원';
        priceElement.style.textDecoration = 'line-through';
        allprice.value = '45000';
    }
    else if(membersheType === '3') {
        discountPriceElement.style.display = 'block';
        discountPriceElement.textContent = '35,000 원';
        priceElement.style.textDecoration = 'line-through';
        allprice.value = '35000';
    }
    else {
        discountPriceElement.style.display = 'none';
        priceElement.style.textDecoration = 'none';
        allprice.value = '50000';
    }
}
...
document.getElementById('contact-form').addEventListener('submit', async (e) => {
    ...
    if(loginCheckRes.ok) {
        try {
            const response = await fetch('/user/commission-project-signage', {
                method: 'POST',
                credentials: "include",
