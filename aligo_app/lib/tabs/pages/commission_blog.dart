...
class BlogCommissionPage extends StatefulWidget {
  const BlogCommissionPage({super.key});

  @override
  State<BlogCommissionPage> createState() => _BlogCommissionPageState();
}

class _BlogCommissionPageState extends State<BlogCommissionPage> {
            ...
            CarouselSlider(
              ...
              items: <Widget>[ // display gallery 이미지들
                SizedBox(
                  ...
                  height: 200,
                  child: Image.asset('assets/images/commission_blog_display_0.png'),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 50,
                  height: 200,
                  child: Image.asset('assets/images/commission_blog_display_1.png'),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 50,
                  height: 200,
                  child: Image.asset('assets/images/commission_blog_display_2.png'),
                ),
              ],
            ),
            const SizedBox(height: 20,),
