...
class BannerCommissionPage extends StatefulWidget {
  const BannerCommissionPage({super.key});

  @override
  State<BannerCommissionPage> createState() => _BannerCommissionPageState();
}

class _BannerCommissionPageState extends State<BannerCommissionPage> {
            ...
            CarouselSlider(
              ...
              items: <Widget>[ // display gallery 이미지들
                SizedBox(
                  ...
                  height: 200,
                  child: Image.asset('assets/images/commission_banner_display_0.png'),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 50,
                  height: 200,
                  child: Image.asset('assets/images/commission_banner_display_1.png'),
                ),
              ],
            ),
            const SizedBox(height: 20,),
