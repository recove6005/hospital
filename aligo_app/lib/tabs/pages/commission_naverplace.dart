...
class NaverplaceCommissionPage extends StatefulWidget {
  const NaverplaceCommissionPage({super.key});

  @override
  State<NaverplaceCommissionPage> createState() => _NaverplaceCommissionPageState();
}

class _NaverplaceCommissionPageState extends State<NaverplaceCommissionPage> {
            ...
            CarouselSlider(
              ...
              items: <Widget>[ // display gallery 이미지들
                SizedBox(
                  ...
                  height: 200,
                  child: Image.asset('assets/images/commission_naverplace_display_0.png'),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 50,
                  height: 200,
                  child: Image.asset('assets/images/commission_naverplace_display_1.png'),
                ),
              ],
            ),
            const SizedBox(height: 20,),
