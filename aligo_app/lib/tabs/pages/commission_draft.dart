...
class DraftCommissionPage extends StatefulWidget {
  const DraftCommissionPage({super.key});

  @override
  State<DraftCommissionPage> createState() => _DraftCommissionPageState();
}

class _DraftCommissionPageState extends State<DraftCommissionPage> {
