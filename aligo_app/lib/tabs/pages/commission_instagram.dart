...
class InstagramCommissionPage extends StatefulWidget {
  const InstagramCommissionPage({super.key});

  @override
  State<InstagramCommissionPage> createState() => _InstagramCommissionPageState();
}

class _InstagramCommissionPageState extends State<InstagramCommissionPage> {
            ...
            CarouselSlider(
              ...
              items: <Widget>[ // display gallery 이미지들
                SizedBox(
                  ...
                  height: 200,
                  child: Image.asset('assets/images/commission_insta_display_0.png'),
                ),
                SizedBox(
                  width: MediaQuery.of(context).size.width - 50,
                  height: 200,
                  child: Image.asset('assets/images/commission_insta_display_1.png'),
                ),
              ],
            ),
            const SizedBox(height: 20,),
